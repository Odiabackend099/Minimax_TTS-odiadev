#!/usr/bin/env python3
"""Generate CallWaiting AI demo using local MiniMax client."""
...
def generate_callwaiting_demo():
    """Generate CallWaiting AI demo with Marcus voice."""
    print("🎤 Generating CallWaiting AI demo with Marcus voice...")
...
def main():
    """Main function."""
    print("🎯 CallWaiting AI - Local Generation")
    print("=" * 60)
    print("Generating CallWaiting AI demo using local MiniMax client...")
    ...
    callwaiting_success = generate_callwaiting_demo()
